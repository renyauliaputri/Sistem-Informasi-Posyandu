...
$id = $_GET['id'];
$data = mysqli_fetch_assoc(mysqli_query($connect, "SELECT * FROM balita WHERE id='$id'"));
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $connect->prepare("UPDATE balita SET nama_balita=?, tanggal_lahir=?, jenis_kelamin=?, nama_ayah=?, nama_ibu=?, alamat=? WHERE id=?");
...
<div class="max-w-xl mx-auto">
    ...
    <div class="bg-white p-6 rounded-2xl shadow-lg">
        ...
        <div class="mb-6">
            ...
            <p class="text-sm text-gray-500">Perbarui data balita</p>
        </div>
        ...
        <form method="POST" class="space-y-5">
            ...
            <div>
                ...
                <div class="flex items-center border rounded-xl px-3 mt-1 focus-within:ring-2 focus-within:ring-[#38b000]">
                    ...
                    <input name="nama_balita"
                        value="<?= htmlspecialchars($data['nama_balita']); ?>"
